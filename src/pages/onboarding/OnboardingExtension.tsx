...
import type { ExtensionDetectionResult } from "@/utils/detectFeatures";
import { detectExtensionInstall } from "@/utils/detectFeatures";
import { getExtensionState } from "@/utils/extension";
import type { ExtensionStatus as AppExtensionStatus } from "@/utils/extension";
...
export function ExtensionStatusCard(props: {
    ...
    <>
          ...
          >
            <span>
              <svg
                ...
                fill="currentColor"
              >
                  <title>{t("onboarding.extension.linkChrome")}</title>
          ...
          >
            <span>
              <svg
                ...
                fill="currentColor"
              >
                  <title>{t("onboarding.extension.linkFirefox")}</title>
      ...
      <div className="mb-6 text-left">
        <div className="flex flex-col items-center space-y-1">
          <Link
            href="https://raw.githubusercontent.com/xp-technologies-dev/userscript/refs/heads/main/p-stream.user.js"
            target="_blank"
            className="text-sm"
          >
