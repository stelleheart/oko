	...
	return (
		<div className="relative min-h-screen">
			...
			<WideContainer ultraWide classNames="!px-0">
				{/* Only render the active tab's carousels. Hidden tabs still mounted
            carousels were running IntersectionObservers and fetch hooks. */}
				{isMoviesTab ? renderMoviesContent() : null}
				{isTVShowsTab ? renderTVShowsContent() : null}
				{isEditorPicksTab ? renderEditorPicksContent() : null}
			</WideContainer>
